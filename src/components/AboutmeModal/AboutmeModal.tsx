        ...
        <div className="flex-1 overflow-y-auto p-8 md:p-16 space-y-20 custom-scrollbar">
          ...
          <motion.section variants={sectionVariants} className="flex flex-col gap-5">
            ...
            <div className="text-slate-700 leading-relaxed md:text-lg space-y-6">
              ...
              <p>
                그중 하나인 <span className={`${ContentsStyle} text-red-500 font-bold`}>VC(Virtual Coin)</span> 프로젝트는 코인 투자 흐름을 가볍게 체험할 수 있는 웹 서비스로 기획부터 개발까지 전 과정을 혼자 진행한
                ...
                수익률 기반의 랭킹 시스템을 통해 자연스러운 경쟁을 유도했습니다. 개발 과정에서는 JWT 토큰을 활용해 엑세스 토큰과 리프레시 토큰으로 인증을 구현했고, 서버-클라이언트 간 도메인, SameSite, Secure 설정을 조정하며 
                쿠키 인증 오류를 해결했습니다. 또한 Axios 인터셉터로 자동 인증 갱신 로직을 구현하고, 웹소켓을 사용해 실시간으로 코인 정보를 가져오도록 하여 사용자 경험을 향상시켰습니다.
              </p>
            </div>
          </motion.section>
