...
const AboutmeModal = ({ handleClose }: AboutmeModalProps) => {
  const modalVariants: Variants = {
    ...
    visible: { opacity: 1, scale: 1, y: 0, transition: { duration: 0.3, ease: "easeIn", when: "beforeChildren", staggerChildren: 0.2 } },
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <h3 className="font-semibold mb-3 text-gray-700">[사용자 니즈를 기능으로 연결한 실질적 개선 경험]</h3>
            <motion.p variants={paragraphVariants} className="text-gray-700 leading-relaxed whitespace-pre-line">
          ...
          >
            ...
            <h3 className="font-semibold mb-3 text-gray-700">[기술보다 앞서야 하는 건 소통과 구조 이해]</h3>
            <motion.p variants={paragraphVariants} className="text-gray-700 leading-relaxed whitespace-pre-line">
              개발자에게 필요한 역량은 단순한 기술 스택의 나열이 아니라 협업 상황에서 문제를 파악하고 구조적으로 해결할 수 있는 역량이라고 생각합니다. 
          ...
          >
            ...
            <h3 className="font-semibold mb-3 text-gray-700">[신뢰받는 동료, 성장하는 프론트엔드 개발자]</h3>
            <motion.p variants={paragraphVariants} className="text-gray-700 leading-relaxed whitespace-pre-line">
