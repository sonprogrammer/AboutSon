...
const points = [
    ...
    { cx: 200, cy: 250, label: '뉴질랜드', content: '뉴질랜드에서의 워킹홀리데이를 통해 혼자 문제를 해결하며 도전 정신과 자기계발 습관을 키웠습니다. 다양한 국적의 사람들과 협업하며 ‘다른 시선을 이해하는 법’을 배웠고, 이 경험이 UI/UX와 프론트엔드 개발에 대한 관심으로 이어졌습니다.' },
