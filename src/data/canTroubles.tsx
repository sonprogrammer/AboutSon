...
export const troubleS: JSX.Element[] = [
  ...
  <>
    ...
    <span className="text-blue-500 font-semibold">
      cors(크로스 오리진 요청 허용) → express-session(세션 쿠키 파싱) → passport.initialize()(passport 초기화) → passport.session()(req.user에 할당)
    </span>{" "}
